...
export class AuthService {
  ...
  private currentUserSubject: BehaviorSubject<UserProfileResponseModel | null> =
    new BehaviorSubject<UserProfileResponseModel | null>(null);
  ...
  public login(data: LoginRequestModel, validateHelper?: ErrorEditorState): Observable<any> {
    return this.http
      .post(this.apiUrl + '/Auth/login', data, { withCredentials: true })
  ...
  public fetchGetProfile(): Observable<UserProfileResponseModel> {
    return this.http
      .get<UserProfileResponseModel>(this.apiUrl + '/Auth/GetProfile', { withCredentials: true })
      .pipe(
        tap((user) => {
